 ...
 */
@Slf4j
public class PostgreSQLSchemaInitializer implements SchemaInitializer {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            String createCompanySettingsTable = """
                CREATE TABLE IF NOT EXISTS company_settings (
                    ...
                    default_payment_deadline_days INTEGER DEFAULT 8,
            ...
            String createCustomersTable = """
                CREATE TABLE IF NOT EXISTS customers (
                    ...
                    payment_deadline_days INTEGER DEFAULT 8,
                    notes TEXT,
            ...
            try (Statement stmt = conn.createStatement()) {
                ...
                stmt.execute("""
                    ...
                    SET property_value = '2.0', updated_at = CURRENT_TIMESTAMP
                    """);

                log.info("PostgreSQL schema initialization completed (version 2.0 with invoicing)");
            }
        }
    }
